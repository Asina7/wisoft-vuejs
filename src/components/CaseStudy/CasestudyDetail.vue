...
<!-- Portfolio area start -->
    ...
    <div class="portfolio__detail-top">
        ...
        <div class="row">
            ...
            <div class="sec-title-wrapper">
                <h2 class="sec-title animation__char_come">{{casestudy.casestudy_title}}</h2>
            </div>
            </div>
    ...
    <div class="portfolio__detail-thumb case-parallax">
        <img ref="parallaxImage" src="@/assets/imgs/portfolio/detail/1.jpg" alt="Portfolio Thumbnail" data-speed="auto" style="position: absolute;">
    </div>
