  ...
  <div>
        ...
        <div class="row">
          <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-8">
            <div class="job__detail-wrapper">
              <h2 class="sec-title">{{ jobdata.job }}</h2>
              ...
              <div class="job__apply" id="btn_wrapper">
                <button class="wc-btn-primary btn-hover btn-item">
                  <span></span> Apply this <br />Position
    ...
    <div class="modal__application" id="application_form">
      <div class="modal__apply">
        <button class="modal__close-2" id="apply_close">
        ...
        <div class="form-apply">
          <form action="#">
            ...
            <div class="input-apply">
              <p>
                Do you have any other designs which you want to show us? or this
                is not available on your portfolio.
              </p>
        ...
        <div class="form-btn apply-trigger">
          <button class="wc-btn-primary btn-hover">
            <span></span> next <i class="fa-solid fa-arrow-right"></i>
          </button>
        </div>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    useHead({
      title: `${current.job} | Digital Marketing Companies in Dubai | Best Digital Marketing Services UAE | Wisoft"`,
      meta: [
        {
          name: `${current.job} | Wisoft Solutions is a full-stack digital marketing company in Dubai, UAE, recognized with multiple digital marketing awards as best digital agency in Dubai.`,
          content: "",
        },
      ],
    });
  ...
  methods: {
    jobApply() {
      ...
      if (job_apply) {
        ...
        // application Modal 2
        const modal_application_2 =
          document.querySelector("#application_form2");
