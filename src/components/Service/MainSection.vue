          ...
          <div class="row">
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div class="sec-title-wrapper wrap">
                <h2
                  class="sec-sub-title title-anim animation__word_come font-ss"
                >
                  service
                </h2>
                <h3 class="sec-title title-anim animation__word_come font-ss">
            ...
            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
              <div class="service__top-text text-anim animation__word_come">
                <p>
                  ...
                  passion for
                  <span>creative problem solving innovations</span> forward
            ...
            <div class="row">
              <div class="col-xxl-4 col-xl-4 col-lg-0 col-md-0">
                <div class="service__img-wrapper image-top">
                  <img
                    src="@/assets/imgs/service/1/1.jpg"
                    alt="Service Image"
                    class="service__img img-1 active"
                  />
                  <img
                    src="@/assets/imgs/service/1/2.png"
                    alt="Service Image"
                    class="service__img img-2"
                  />
                  <img
                    src="@/assets/imgs/service/1/3.png"
                    alt="Service Image"
                    class="service__img img-3"
                  />
                  <img
                    src="@/assets/imgs/service/1/4.png"
                    alt="Service Image"
                ...
                <div class="service__list">
                  <a>
                    <router-link :to="'/servicedetail/digital-marketing'">
                      <div
                        class="service__item animation_home1_service"
                        data-service="1"
                      >
                        ...
                        <div class="service__text">
                          <p>
                            ...
                            companies all around the world class digital
                            products
                          </p>
                        </div>
                  ...
                  <a>
                    <router-link
                      :to="'/servicedetail/search-engine-optimization'"
                    >
                      <div
                        class="service__item animation_home1_service"
                        data-service="3"
                  ...
                  <a>
                    <router-link :to="'/servicedetail/web-design-development'">
                      <div
                        class="service__item animation_home1_service"
                        data-service="6"
                      >
        ...
        <div class="container pt-140 pb-100">
          <div class="row">
            <div class="col-xxl-12">
              <h2 class="brand__title-3 title-anim brand-4">
                THE DIGITAL TEAM<br />TO POWER YOUR DREAM
              </h2>
          ...
          <div class="row">
            <div class="col-xxl-12">
              <div class="cta__content">
                ...
                <h2 class="cta__title title-anim color-cta">
            ...
            <a href="contact.html" class="wc-btn-primary btn-item btn-hover"><span></span>Let’s talk us <i
                ...
                <div class="btn-dark-container" style="text-align: center">
                  <a class="btn-dark" href="/contact"
                    >Let's Talk <i class="fa-solid fa-circle-arrow-right"></i
                  ></a>
                </div>
              </div>
            </div>
